...
小米手环 10 本身无法联网。Pulse 2.0 内置 `pulse-core`，直接通过蓝牙连接手环、安装应用和表盘、为手环代取数据。**不再需要 OronBox 或任何第三方桥接软件。**
...
1. 从 [Releases](../../releases/latest) 下载最新的 `Pulse-Setup-x.y.z.exe` 并安装。从 1.x 升级直接覆盖安装即可。
